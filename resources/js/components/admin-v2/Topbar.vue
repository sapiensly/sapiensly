...
<template>
    ...
    >
        ...
        <button
            ...
            :aria-label="
                sidebarCollapsed
                    ? t('admin_v2.topbar.expand_sidebar')
                    : t('admin_v2.topbar.collapse_sidebar')
            "
        ...
        >
            <span>{{ t('admin_v2.breadcrumb.root') }}</span>
        ...
        >
            ...
            <span class="flex-1 text-left">
                {{ t('admin_v2.topbar.search_placeholder') }}
            </span>
            <kbd
        ...
        <button
            ...
            :aria-label="t('admin_v2.topbar.notifications')"
        >
            <Bell class="size-4" />
            <span
