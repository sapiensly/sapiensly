...
function relativeTime(iso: string | null): string {
    if (!iso) return t('admin_v2.users.last_seen.never');
        ...
        <Table>
            <TableHeader class="bg-navy-deep/60">
                <TableRow class="border-soft hover:bg-transparent">
                    ...
                    >
                        {{ t('admin_v2.users.col.org') }}
                    </TableHead>
                    <TableHead
                        class="text-[10px] font-semibold tracking-wider text-ink-subtle uppercase"
                    >
                        {{ t('admin_v2.users.col.role') }}
                    </TableHead>
                    <TableHead
                        class="text-[10px] font-semibold tracking-wider text-ink-subtle uppercase"
                    >
                        {{ t('admin_v2.users.col.status') }}
                    </TableHead>
                    <TableHead
                        class="text-[10px] font-semibold tracking-wider text-ink-subtle uppercase"
                    >
                        {{ t('admin_v2.users.col.two_factor') }}
                    </TableHead>
                    <TableHead
                        class="cursor-pointer text-[10px] font-semibold tracking-wider text-ink-subtle uppercase"
                    ...
                    >
                        <span class="inline-flex items-center gap-1">
                            {{ t('admin_v2.users.col.last_seen') }}
                            <ChevronDown
            ...
            <TableBody>
                ...
                >
                    ...
                    <TableCell>
                        ...
                        >
                            {{ t(`admin_v2.users.role.${user.role}`) }}
                        </span>
                    </TableCell>
                    ...
                    <TableCell>
                        ...
                        >
                            <component
                                ...
                                class="size-3"
                            />
                            {{ t(`admin_v2.users.status.${user.status}`) }}
                        </span>
                    </TableCell>
                    ...
                    <TableCell>
                        ...
                        >
                            <Shield class="size-3" />
                            {{ t('admin_v2.users.two_factor.on') }}
                        </span>
                        <span v-else class="text-xs text-ink-subtle">
                            {{ t('admin_v2.users.two_factor.off') }}
                        </span>
                    </TableCell>
