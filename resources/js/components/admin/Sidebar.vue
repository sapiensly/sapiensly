...
const navItems = computed<NavItem[]>(() => [
    {
        ...
        href: '/admin',
        icon: NavDashboard,
        match: (u) => u === '/admin' || u.startsWith('/admin?'),
    },
    {
        key: 'users',
    ...
    },
    {
        ...
        href: '/admin/access',
        icon: NavAccess,
        match: (u) => u.startsWith('/admin/access'),
    },
    {
        key: 'ai',
        label: t('admin.nav.ai_full'),
        href: '/admin/ai',
        icon: NavAi,
        match: (u) => u.startsWith('/admin/ai'),
    },
    {
        key: 'cloud',
        label: t('admin.nav.cloud_full'),
        href: '/admin/cloud',
        icon: NavCloud,
    ...
    },
    {
        ...
        href: '/admin/stack',
        icon: NavStack,
        match: (u) => u.startsWith('/admin/stack'),
    },
]);
