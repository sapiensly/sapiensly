...
function submit() {
    ...
    form.post(`/admin/ai/providers/${props.providerId}/rotate-key`, {
        preserveScroll: true,
        onSuccess: () => {
            open.value = false;
            form.reset();
        ...
        >
            <DialogHeader>
                <DialogTitle class="flex items-center gap-2 text-ink">
                    ...
                    {{ t('admin.ai.rotate.title') }}
                </DialogTitle>
                <DialogDescription class="text-ink-muted">
                    {{ t('admin.ai.rotate.description') }}
                </DialogDescription>
            </DialogHeader>
            ...
            <form class="space-y-3" @submit.prevent="submit">
                <div class="space-y-1.5">
                    <Label for="rotate-key-input" class="text-xs">
                        {{ t('admin.ai.rotate.new_key_label') }}
                    </Label>
                    <Input
                        id="rotate-key-input"
                        ...
                        type="password"
                        autocomplete="off"
                        :placeholder="t('admin.ai.rotate.new_key_placeholder')"
                        class="font-mono"
                    />
                    <p
