...
const BlockLeadForm = defineAsyncComponent(
    () => import('./blocks/BlockLeadForm.vue'),
);
...
const BlockRecordForm = defineAsyncComponent(
    () => import('./blocks/BlockRecordForm.vue'),
);
