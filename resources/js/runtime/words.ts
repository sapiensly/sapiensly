...
const WORDS: Record<string, Dict> = {
    en: {
        ...
        scan_torch: 'Light',
        scale_button: 'Weigh',
        track_start: 'Start recording my route',
        track_running: 'Recording your route',
        track_stop: 'Stop',
        track_only_open: 'Only while this app is open on your screen',
        track_pending: '{n} points waiting to be sent',
        track_denied: 'Location was refused, so nothing is being recorded.',
        track_unsupported: 'This device cannot report its location.',
        track_refused: 'This app does not record routes.',
        identity_refused:
    ...
    es: {
        ...
        track_start: 'Empezar a registrar mi recorrido',
        track_running: 'Registrando tu recorrido',
        track_stop: 'Detener',
        track_only_open: 'Solo mientras esta app esté abierta en tu pantalla',
        track_pending: '{n} puntos por enviar',
        track_denied:
            'Se negó la ubicación, así que no se está registrando nada.',
        track_unsupported: 'Este dispositivo no puede dar su ubicación.',
        track_refused: 'Esta app no registra recorridos.',
        identity_refused:
    ...
    pt: {
        ...
        scale_button: 'Pesar',
        scale_reading: 'Lendo…',
        track_start: 'Começar a registrar meu trajeto',
        track_running: 'Registrando seu trajeto',
        track_stop: 'Parar',
        track_only_open: 'Só enquanto este app estiver aberto na sua tela',
        track_pending: '{n} pontos a enviar',
        track_denied:
            'A localização foi negada, então nada está sendo registrado.',
        track_unsupported:
            'Este aparelho não consegue informar sua localização.',
        track_refused: 'Este app não registra trajetos.',
        identity_refused:
    ...
    fr: {
        ...
        scan_torch: 'Lumière',
        scale_button: 'Peser',
        track_start: 'Commencer à enregistrer mon trajet',
        track_running: 'Enregistrement de votre trajet',
        track_stop: 'Arrêter',
        track_only_open: 'Uniquement tant que cette app est ouverte à l’écran',
        track_pending: '{n} points à envoyer',
        track_denied: 'La position a été refusée : rien n’est enregistré.',
        track_unsupported: 'Cet appareil ne peut pas indiquer sa position.',
        track_refused: 'Cette app n’enregistre pas de trajets.',
        identity_refused:
