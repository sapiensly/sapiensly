...
export const adminHighlight = HighlightStyle.define([
    ...
    {
        tag: [t.attributeValue, t.string, t.special(t.string)],
        color: '#22c55e',
    },
    { tag: [t.number, t.bool, t.null], color: '#f59e0b' },
    {
        tag: [t.keyword, t.controlKeyword, t.modifier, t.self],
        color: '#0096ff',
        fontWeight: '500',
    },
...
export const adminTheme = EditorView.theme(
    {
        ...
        '.cm-selectionBackground, ::selection': {
            backgroundColor:
                'color-mix(in oklab, var(--sp-accent-blue) 28%, transparent) !important',
        },
        '&.cm-focused': {
            outline: 'none',
        },
