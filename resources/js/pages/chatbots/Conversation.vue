...
import type { Chatbot, WidgetConversation, WidgetMessage } from '@/types/chatbot';
                        ...
                        <Card>
                            ...
                            <CardContent class="space-y-4">
                                <div class="flex items-center gap-3">
                                    <div class="flex h-12 w-12 items-center justify-center rounded-full bg-muted text-lg font-medium">
                                ...
                                <div class="space-y-3 text-sm">
                                    <div v-if="conversation.session?.visitor_email" class="flex items-center gap-2">
                                        <Mail class="h-4 w-4 text-muted-foreground" />
                                        <span>{{ conversation.session.visitor_email }}</span>
                                    </div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div class="flex items-center gap-2 text-xs text-muted-foreground">
                                        ...
                                        <span v-if="message.response_time_ms" class="text-xs">
                                            &bull; {{ message.response_time_ms }}ms
                                        </span>
                                    </div>
                                </div>
                            </div>
