...
const replyTo = computed(
    () =>
        ...
        props.conversation.session?.visitor_email ||
        null,
);
...
<template>
    ...
    <AppLayoutV2 :title="t('app_v2.nav.chatbots')">
        <div class="mx-auto max-w-4xl space-y-6">
            ...
            <!--
                    The whole point of the handoff work: this visitor asked for
                    a person and nobody has replied. Loud, at the top, with the
                    address to reply to — not a badge in a sidebar.
                -->
            <div
                v-if="handoff"
            ...
            >
                <div class="flex items-start gap-3">
                    <UserRound class="mt-0.5 h-5 w-5 text-destructive" />
                    <div class="space-y-1">
                        <p class="font-medium">
                            {{ t('chatbots.conversation.asked_for_person') }}
                            <span class="text-muted-foreground">
                                &bull; {{ formatDate(handoff.at) }}
                            </span>
                        </p>
                        <p
                            v-if="handoff.reason"
                        ...
                        <p class="text-sm">
                            <template v-if="replyTo">
                                {{ t('chatbots.conversation.reply_to') }}
                                <a
                                    :href="`mailto:${replyTo}`"
                            ...
                            <span v-else class="text-muted-foreground">
                                {{
                                    t('chatbots.conversation.no_reply_address')
                                }}
                            </span>
                        </p>
                    </div>
                    ...
                    <Card>
                        ...
                        <CardContent class="space-y-4">
                                    ...
                                    <p class="font-medium">
                                        {{
                                            conversation.session
                                                ?.visitor_name ||
                                            t('chatbots.conversation.anonymous')
                                        }}
                                    </p>
                                    <p
                                        v-if="
                            ...
                            <div class="space-y-3 text-sm">
                                <div
                                    v-if="conversation.session?.visitor_email"
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span
                                        ...
                                        {{
                                            t('chatbots.conversations.messages')
                                        }}</span
                                    >
                                </div>
                                <div class="flex items-center gap-2">
