...
sapiensly('destroy');</code></pre>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            >
                            <CardDescription>
                                Identify logged-in users to personalize their
                                experience and track conversations.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <pre
                    ...
                    <div class="space-y-4">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    ...
                                    >
                                        <li>
                                            Check that the embed code is placed
                                            before the closing &lt;/body&gt; tag
                                        </li>
                                        <li>
                                            Verify that your domain is in the
                                            "Allowed Origins" list in chatbot
                                            settings
                                        </li>
                                        <li>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                >
                                <CardDescription>
                                    Add your website's domain to the "Allowed
                                    Origins" in the chatbot settings. Use the
                                    exact origin format:
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                >
                                <CardDescription>
                                    The widget uses isolated styles, but if you
                                    notice conflicts, check for global CSS rules
                                    that might affect elements inside the widget
                                    container (#sapiensly-widget).
                                </CardDescription>
                            </CardHeader>
                        </Card>
                    </div>
