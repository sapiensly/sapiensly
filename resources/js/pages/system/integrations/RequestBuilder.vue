...
function save(): void {
    form.put(`/system/integrations/requests/${props.request.id}`, {
        preserveScroll: true,
    });
}
                        ...
                        <Tabs default-value="params">
                            ...
                            <TabsContent value="body" class="mt-3 space-y-2">
                                <Select v-model="form.body_type">
                                    ...
                                    <SelectContent>
                                        ...
                                        <SelectItem value="form_urlencoded"
                            ...
                            >
                                <p class="text-xs text-muted-foreground">
                                    Override active environment variables just
                                    for this test run.
                                </p>
                                <div
                                ...
                                >
                                    <code class="w-40 font-mono text-xs">{{
