...
const stackItems = computed(() => [
    {
        name: t('system.stack.php'),
        version: props.stack.php,
        color: 'bg-indigo-500',
    },
    {
        name: t('system.stack.laravel'),
        version: props.stack.laravel,
        color: 'bg-red-500',
    },
    {
        name: t('system.stack.laravel_ai'),
        version: props.stack.laravel_ai,
        color: 'bg-violet-500',
    },
    {
        name: t('system.stack.nodejs'),
        version: props.stack.node,
        color: 'bg-green-500',
    },
    {
        name: t('system.stack.vuejs'),
        version: version,
        color: 'bg-emerald-500',
    },
    {
        name:
            props.stack.database.driver.charAt(0).toUpperCase() +
            props.stack.database.driver.slice(1),
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    >
                                        <span
                                            ...
                                            class="mr-1 inline-block h-1.5 w-1.5 animate-pulse rounded-full bg-green-400"
                                        />
