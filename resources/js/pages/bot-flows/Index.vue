...
import type { BotFlow } from '@/types/botFlows';
...
const breadcrumbs = computed<BreadcrumbItem[]>(() => [
    ...
    },
    {
        ...
        href: BotFlowController.index({ agent: props.agent.id }).url,
    },
]);
...
const deleteFlow = (flow: BotFlow) => {
    router.delete(
        BotFlowController.destroy({
        ...
        <div class="px-4 py-6">
            <div class="mx-auto max-w-4xl">
                <div class="mb-8 flex items-center justify-between">
                    ...
                    <Button as-child>
                        <Link
                            :href="BotFlowController.create({ agent: agent.id })"
                        >
