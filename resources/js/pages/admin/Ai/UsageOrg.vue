    ...
    <AdminLayout :title="`AI Usage · ${organization.name}`">
        <div class="space-y-6">
            <header class="flex items-start justify-between gap-3">
                <div class="space-y-1">
                    <Link
                        :href="`/admin/ai/usage?days=${days}`"
                        class="inline-flex items-center gap-1 text-xs text-accent-blue hover:underline"
                    >
            ...
            >
                <StatCard
                    ...
                    :series="
                        report.series.system.map(
                            (v, i) => v + report.series.own[i],
                        )
                    "
                    :icon="Coins"
