...
#[Description('Apply a set of RFC 6902 JSON Patch operations to an app\'s manifest. The patch is validated and, if valid, saved as a new (reversible) app version. Read the manifest first to target the right paths.')]
class ProposeChangeTool extends SapiensTool
{
    ...
    public function handle(Request $request): Response
    {
        ...
        try {
            ...
            // Validation / patch failures come back as a legible message the
            // model can act on rather than an opaque 500.
            return Response::error('The change was rejected: '.$e->getMessage());
        }
