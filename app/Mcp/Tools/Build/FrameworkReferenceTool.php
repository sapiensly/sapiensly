...
#[Description('Detailed authoring reference for building apps. Call with no topic to list topics (forms, workflows, derived_fields, expressions, design, custom_css, permissions, verification, connected_objects, example), then call again with a topic. `custom_css` covers the scoped raw-CSS escape hatch (auto-isolated per app) + the data-block-* targeting hooks; `permissions` covers the enforced access layer.')]
