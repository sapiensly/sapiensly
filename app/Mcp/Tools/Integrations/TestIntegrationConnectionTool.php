...
#[Description('Test that an integration (connection) can reach its endpoint with its configured auth, without performing any real operation.')]
class TestIntegrationConnectionTool extends SapiensTool
{
    ...
    {
        return [
            'integration_id' => $schema->string()->description('The id of the integration to test.')->required(),
        ];
    }
}
