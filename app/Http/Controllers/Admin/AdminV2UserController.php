...
use App\Http\Requests\AdminV2\DeleteUserRequest;
use App\Http\Requests\AdminV2\InviteUserRequest;
use App\Models\User;
 ...
 */
class AdminV2UserController extends Controller
{
    ...
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('admin-v2/Users/Index', [
            'users' => [
    ...
    public function destroy(DeleteUserRequest $request, User $user): RedirectResponse
    {
        ...
        return to_route('admin2.users.index')->with('success', $message);
    }
