...
afterwards). Returns {ok, integration_id, status:"draft", authorize_required}.
DESC;
    }
    ...
    public function handle(Request $request): string
    {
        ...
        return json_encode([
            ...
            'authorize_required' => $resolvedType !== IntegrationAuthType::None,
            'message' => 'Draft connection created. It must be authorized before use; then call test_connection to verify it.',
        ], JSON_THROW_ON_ERROR);
    }
}
