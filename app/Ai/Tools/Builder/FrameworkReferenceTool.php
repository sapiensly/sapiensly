...
1. SURFACE: set settings.surface="landing" (renders public, chrome-less, full-bleed — the page brings its own navbar/footer sections) and settings.accent to the brand accent. Add settings.seo {title, description, og_image} — it drives the public page's <head>.
