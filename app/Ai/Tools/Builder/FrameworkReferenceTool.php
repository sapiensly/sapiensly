...
3. COMPOSE BESPOKE: author each section as an `html` block (semantic markup with YOUR OWN class/id) and put ALL styling in settings.custom_css targeting those classes (landing budget: up to 60,000 chars). Aim for: a real display type scale (clamp up to ~3-4.5rem, tight tracking), a committed palette (a chosen neutral + a confident accent), asymmetry and tension (NOT everything centered), depth (gradients/glow/grain). Inline `style`, <script>, <style> and event handlers are STRIPPED on save — styling lives in custom_css only.
