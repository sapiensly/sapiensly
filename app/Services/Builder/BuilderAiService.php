...
class BuilderAiService
{
    ...
    public function sendMessage(BuilderConversation $conversation, string $userText): BuilderMessage
    {
        ...
        $tools = [
            ...
            new AddConnectedObjectTool($proposeTool, app(McpClient::class), app(ConnectedObjectModeler::class), $conversation->user),
