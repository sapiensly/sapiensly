...
class DocWords
{
    ...
    private const WORDS = [
        'en' => [
            ...
            'task_detail_children' => 'Its own page also lists its {list}.',
        ...
        'es' => [
            ...
            'task_detail_children' => 'Su propia página también lista sus {list}.',
            ...
            't_relation_many' => 'Los {n} ligados',
            't_formula' => 'Se calcula solo',
            't_lookup' => 'Se toma del {n} ligado',
            't_rollup' => 'Se calcula a partir de sus {n}',
            't_rollup_count' => 'Cuántos {n} tiene',
        ...
        'pt' => [
            ...
            'task_detail_children' => 'A sua própria página também lista seus {list}.',
            ...
            't_relation_many' => 'Os {n} ligados',
            't_formula' => 'Calcula-se sozinho',
            't_lookup' => 'Vem do {n} ligado',
            't_rollup' => 'Calcula-se a partir dos seus {n}',
            't_rollup_count' => 'Quantos {n} tem',
            't_rollup_sum' => 'A soma dos seus {n}',
            't_rollup_sum_of' => 'A soma de {f} dos seus {n}',
        ...
        'fr' => [
            ...
            'task_detail_children' => 'Sa propre page liste aussi ses {list}.',
            ...
            't_relation_one' => 'À quel {n} il appartient',
            't_relation_many' => 'Les {n} liés',
            't_formula' => 'Se calcule tout seul',
            't_lookup' => 'Repris du {n} lié',
