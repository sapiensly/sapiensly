...
final class IconCatalog
{
    ...
    public const NAMES = [
        ...
        'lock', 'mail', 'map', 'map-pin', 'message-circle', 'message', 'mic', 'minus', 'minus-circle',
        'monitor', 'moon', 'more', 'navigation', 'package', 'palette', 'paperclip',
        'pencil', 'edit', 'percent', 'phone', 'pie-chart', 'piggy-bank', 'plane',
        'play', 'plus', 'plus-circle', 'printer', 'qr-code', 'receipt', 'refresh', 'rocket', 'save',
        'scale', 'search', 'send', 'settings', 'share', 'shield', 'shield-check',
        'shopping-bag', 'shopping-cart', 'sigma', 'smartphone', 'smile', 'sparkles', 'star',
        'stethoscope', 'store', 'sun', 'tag', 'target', 'thumbs-down', 'thumbs-up', 'trash',
