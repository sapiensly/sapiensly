...
/**
 * Promotes `playground_benchmarks` to a tenant data table — a benchmark's
 * prompt and decision notes are tenant data and must sit under Row-Level
 * Security like the member runs. Mirrors
 * {@see 2026_07_19_900001_move_playground_runs_to_tenant}.
 *
...
return new class extends Migration
{
    ...
    private const TABLE = 'playground_benchmarks';
