...
/**
 * Promotes `app_user_roles` to a tenant data table — an app-role grant belongs
 * to the app's tenant and must sit under the same Row-Level Security as the
 * records it governs. Mirrors {@see 2026_06_20_900001_move_widget_attachments_to_tenant}.
 *
...
return new class extends Migration
{
    ...
    private const TABLE = 'app_user_roles';
