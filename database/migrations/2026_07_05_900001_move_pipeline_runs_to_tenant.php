...
/**
 * Promotes `pipeline_runs` to a tenant data table — an Express run's state and
 * telemetry belong to the tenant that launched it and must sit under the same
 * Row-Level Security as the builder conversations it reports into. Mirrors
 * {@see 2026_07_01_900001_move_deck_versions_to_tenant}.
 *
...
return new class extends Migration
{
    ...
    private const TABLE = 'pipeline_runs';
