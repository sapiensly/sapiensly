...
/**
 * Promotes `playground_runs` to a tenant data table — a run's prompt and model
 * response are tenant data and must sit under Row-Level Security like every
 * other AI artifact. Mirrors {@see 2026_07_05_900001_move_pipeline_runs_to_tenant}.
 *
...
return new class extends Migration
{
    ...
    private const TABLE = 'playground_runs';
